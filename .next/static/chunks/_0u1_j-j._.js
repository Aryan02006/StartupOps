...
"[project]/lib/stores/authStore.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const useAuthStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["create"])()((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persist"])((set)=>({
        ...
        initAuth: ()=>{
            ...
            if (token) {
                ...
                fetch(`${("TURBOPACK compile-time value", "http://localhost:3001/api") || 'http://localhost:3001/api'}/auth/me`, {
                    headers: {
...
function Providers(t0) {
    ...
    if ($[0] !== "946e92b6717e748afcc8f0ed3ab2e8526cb36dcc97fe20e8a91bbe0a596d3a47") {
        for(let $i = 0; $i < 7; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "946e92b6717e748afcc8f0ed3ab2e8526cb36dcc97fe20e8a91bbe0a596d3a47";
    }
    const { children } = t0;
    ...
    const initAuth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$stores$2f$authStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])(_ProvidersUseAuthStore);
    let t1;
    let t2;
    if ($[1] !== initAuth) {
        t1 = ({
...
_s(Providers, "22kwBI0B9bur0/As+jNjkC+5Iqc=", false, function() {
    return [
...
_c = Providers;
function _ProvidersUseAuthStore(state) {
...
//# sourceMappingURL=_0u1_j-j._.js.map