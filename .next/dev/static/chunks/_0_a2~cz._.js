...
"[project]/components/workspace/WorkspaceOverview.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function WorkspaceOverview(t0) {
    ...
    if ($[0] !== "da6ff785b4cdcc9bbd3a109ca4483d8284e8ba9efcc6c0cf7d7b5ec214118fa6") {
        for(let $i = 0; $i < 87; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "da6ff785b4cdcc9bbd3a109ca4483d8284e8ba9efcc6c0cf7d7b5ec214118fa6";
    }
    ...
    const { data: workspace, isLoading: workspaceLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])(t1);
    let t2;
    let t3;
    if ($[3] !== workspaceId) {
        t2 = [
        ...
        t3 = async ()=>{
            const response_0 = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["taskAPI"].getByWorkspace(workspaceId);
    ...
    const { data: tasks } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])(t5);
    let t6;
    let t7;
    if ($[10] !== workspaceId) {
        t6 = [
        ...
        t7 = async ()=>{
            const response_1 = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["milestoneAPI"].getByWorkspace(workspaceId);
    ...
    const { data: milestones } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])(t9);
    if (workspaceLoading) {
        let t10;
        if ($[17] === Symbol.for("react.memo_cache_sentinel")) {
            t10 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    fileName: "[project]/components/workspace/WorkspaceOverview.tsx",
                    lineNumber: 106,
                    columnNumber: 69
                }, this)
            }, void 0, false, {
    ...
    let t10;
    if ($[19] !== tasks) {
        t10 = tasks?.filter(_WorkspaceOverviewAnonymous).length || 0;
        $[19] = tasks;
        $[20] = t10;
    } else {
        t10 = $[20];
    }
    const completedTasks = t10;
    let t11;
    if ($[21] !== completedTasks || $[22] !== totalTasks) {
        t11 = totalTasks > 0 ? Math.round(completedTasks / totalTasks * 100) : 0;
        $[21] = completedTasks;
        $[22] = totalTasks;
        $[23] = t11;
    } else {
    ...
    let t36;
    if ($[62] !== t17 || $[63] !== t23 || $[64] !== t29 || $[65] !== t35) {
    ...
    let t39;
    if ($[69] !== completedTasks || $[70] !== totalTasks) {
        ...
        t44 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
            ...
            children: [
                ...
                tasks && tasks.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "space-y-3",
                    children: tasks.slice(0, 5).map(_WorkspaceOverviewAnonymous2)
                }, void 0, false, {
                    fileName: "[project]/components/workspace/WorkspaceOverview.tsx",
                    lineNumber: 390,
                    columnNumber: 67
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "Create tasks to see activity here"
                        }, void 0, false, {
                            fileName: "[project]/components/workspace/WorkspaceOverview.tsx",
                            lineNumber: 390,
                            columnNumber: 229
    ...
    let t45;
    if ($[80] !== workspace.description) {
        t45 = workspace.description && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
            className: "p-6",
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                    className: "text-lg font-semibold text-gray-900 mb-3",
                    children: "About This Workspace"
                }, void 0, false, {
                    fileName: "[project]/components/workspace/WorkspaceOverview.tsx",
                    lineNumber: 398,
                    columnNumber: 58
        ...
        $[80] = workspace.description;
        $[81] = t45;
    } else {
        t45 = $[81];
    }
    let t46;
    if ($[82] !== t36 || $[83] !== t42 || $[84] !== t44 || $[85] !== t45) {
...
_s(WorkspaceOverview, "rqSUCBS/TW/BwhC6fCN1S7Mo0Xk=", false, function() {
    return [
...
function _WorkspaceOverviewAnonymous2(task) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "flex items-center gap-3 p-3 bg-gray-50 rounded-lg",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: `w-2 h-2 rounded-full ${task.status === "done" ? "bg-green-500" : task.status === "in-progress" ? "bg-blue-500" : "bg-gray-400"}`
            }, void 0, false, {
                fileName: "[project]/components/workspace/WorkspaceOverview.tsx",
                lineNumber: 418,
                columnNumber: 91
            ...
            task.priority && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                className: `text-xs px-2 py-1 rounded-full ${task.priority === "high" ? "bg-red-100 text-red-700" : task.priority === "medium" ? "bg-yellow-100 text-yellow-700" : "bg-gray-100 text-gray-700"}`,
...
function _WorkspaceOverviewAnonymous(t) {
...
//# sourceMappingURL=_0_a2~cz._.js.map
